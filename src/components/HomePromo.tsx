const HomePromo = () => {
  return (
    <section
      ...
      className="max-w-screen-xl mx-auto py-8 px-4 lg:py-16 lg:px-6 bg-[#014038]"
    >
        ...
        <div className="flex-1 flex flex-col sm:flex-row flex-wrap -mb-4 -mx-2">
          <div className="w-full sm:w-1/2 mb-4 px-2 ">
            <div className="h-full py-4 px-6 border border-[#F0C06D] border-t-0 border-l-0 rounded-br-xl">
              ...
              <p className="text-sm text-gray-100">
                Don't miss out on savings! Get 15% off any of our classes for a
                limited time.
              </p>
              <a href="/gallery">
          ...
          <div className="w-full sm:w-1/2 mb-4 px-2 ">
            <div className="h-full py-4 px-6 border border-[#F0C06D] border-t-0 border-l-0 rounded-br-xl mb-3">
              ...
              <p className="text-sm text-gray-100">
                Transform your yard with our expert planting service. A greener
          ...
          <div className="w-full sm:w-1/2 mb-4 px-2 ">
            <div className="h-full py-4 px-6 border border-[#F0C06D] border-t-0 border-l-0 rounded-br-xl">
              ...
              <p className="text-sm text-gray-100">
                Superior soil for superior gardens. Enrich your garden beds with
                our nutrient-rich soil.
              </p>
              <a href="/gallery">
                <button className="btn btn-block mt-4 mb-4 hover:bg-[#F0C06D] text-[#00231C] bg-[#BDD4DA]">
                  Book Now
