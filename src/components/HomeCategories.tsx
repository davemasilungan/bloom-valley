...
const HomeCategories = () => {
  return (
    <section
      ...
      className="mb-14 mt-14 bg-[#F7F7F7] pt-20 pb-20"
    >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4 h-full">
          <div className="col-span-2 sm:col-span-1 md:col-span-2 bg-gray-50 h-auto md:h-full flex flex-col">
            <Link
              ...
              aria-label="View our tree services"
          ...
          <div className="col-span-2 sm:col-span-1 md:col-span-2 bg-stone-50">
            <Link
              href="/gallery"
              onClick={(e) => e.preventDefault()}
              aria-label="Shop our garden supplies"
            ...
            <div className="grid gap-4 grid-cols-2 sm:grid-cols-2 lg:grid-cols-2">
              ...
              <Link
                href="/gallery"
                onClick={(e) => e.preventDefault()}
                aria-label="See our soil selection"
                className="group relative flex flex-col overflow-hidden rounded-2xl px-4 pb-4 pt-40"
              >
                <img
          ...
          <div className="col-span-2 sm:col-span-1 md:col-span-1 bg-sky-50 h-auto md:h-full flex flex-col">
            <Link
              href="/gallery"
              onClick={(e) => e.preventDefault()}
              aria-label="Sign up for our classes"
              className="group relative flex flex-col overflow-hidden rounded-2xl px-4 pb-4 pt-40 flex-grow"
            >
              <img
